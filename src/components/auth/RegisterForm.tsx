    ...
    <div className="min-h-screen bg-surface flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-text/80">Crea tu cuenta</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="elegant-card p-8 rounded-lg backdrop-blur-md">
          ...
          <div className="space-y-6">
            <div>
              <label className="block text-sm font-medium text-text/80 mb-2" htmlFor="nombre">
                Nombre Completo
              </label>
            ...
            <div className="flex items-center">
              <input
                ...
                required
              />
              <label htmlFor="terminos" className="ml-2 block text-sm text-text/80">
                Acepto los{' '}
